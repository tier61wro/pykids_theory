...
2. Используя вложенные условия, определите, сколько студент должен заплатить за билет в кино (например, базовая цена — 10 доллары, студенты платят на 2 доллара меньге, а если у студента еще и дисконтная карта, то он платит еще на доллар меньше).
